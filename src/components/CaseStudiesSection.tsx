...
export const CaseStudiesSection: React.FC = () => {
  return (
    <section id="projects" className="bg-[#F5F5F5] pt-16 sm:pt-20 lg:pt-28 pb-16 sm:pb-20 lg:pb-28 overflow-hidden">
      <div className="w-full max-w-[1440px] mx-auto">
        ...
        <div className="px-5 sm:px-8 lg:px-12">
          <h2 className="text-gray-900 font-medium leading-[1.08] tracking-[-0.03em] text-[clamp(1.75rem,7vw,4.2rem)] sm:text-[clamp(2.5rem,5vw,4.2rem)] mb-10 sm:mb-14 lg:mb-16">
            Our projects
          </h2>
        </div>
