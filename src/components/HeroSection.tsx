    ...
    <section className="relative w-full h-screen min-h-screen bg-[#EFEFEF] dark:bg-[#0B0F1A] overflow-hidden flex flex-col justify-end pb-14 sm:pb-16 lg:pb-20 transition-colors duration-300">
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 pt-24 md:pt-32">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5">
          ...
          <div className="interactive-glow bg-white dark:bg-slate-800/80 dark:backdrop-blur-sm flex items-center gap-2 rounded-[4px] py-1.5 pl-2 pr-1.5 shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] transition-all duration-300 cursor-pointer">
