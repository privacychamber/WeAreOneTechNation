    ...
    <section className="relative w-full h-screen min-h-screen bg-[#EFEFEF] overflow-hidden flex flex-col justify-between">
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20 mt-auto">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5">
          <button className="group bg-[#F26522] hover:bg-[#e05a1a] text-white text-[13px] leading-[14px] font-medium rounded-full pl-5 sm:pl-6 pr-2 py-2 flex items-center gap-3 transition-colors duration-300">
            <div className="flex-col overflow-hidden h-[20px] relative w-auto">
              <div className="flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] group-hover:-translate-y-1/2">
            ...
            <div className="bg-white text-[#F26522] w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center">
