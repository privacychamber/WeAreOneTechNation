    ...
    <section className="relative w-full h-screen min-h-screen bg-[#EFEFEF] dark:bg-[#0B0F1A] overflow-hidden flex flex-col justify-end pb-28 sm:pb-16 lg:pb-20 transition-colors duration-300">
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 pt-24 md:pt-32">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
          ...
          <div className="interactive-glow bg-white dark:bg-slate-800/80 dark:backdrop-blur-sm flex items-center gap-2 rounded-[4px] py-1.5 pl-2 pr-1.5 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer border border-transparent hover:border-[#2563eb]/20">
        ...
        {/* Trust Signals */}
        <div className="mt-8 sm:mt-12 flex items-center gap-4 opacity-80 transition-opacity hover:opacity-100">
           <div className="flex -space-x-3">
             <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=64&h=64&q=80" className="w-8 h-8 rounded-full border-2 border-[#EFEFEF] dark:border-[#0B0F1A]" alt="Client" />
             <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=64&h=64&q=80" className="w-8 h-8 rounded-full border-2 border-[#EFEFEF] dark:border-[#0B0F1A]" alt="Client" />
             <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=64&h=64&q=80" className="w-8 h-8 rounded-full border-2 border-[#EFEFEF] dark:border-[#0B0F1A]" alt="Client" />
             <div className="w-8 h-8 rounded-full border-2 border-[#EFEFEF] dark:border-[#0B0F1A] bg-gray-100 dark:bg-slate-800 flex items-center justify-center text-[10px] font-bold text-gray-900 dark:text-white">+50</div>
           </div>
           <div className="text-[13px] text-gray-600 dark:text-gray-400 font-medium">
             Trusted by <span className="text-[#2563eb] font-bold">50+</span> global brands
           </div>
        </div>
