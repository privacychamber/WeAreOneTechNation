  ...
  return (
    <div className="pt-32">
      ...
      <section className="py-20 md:py-32 container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-white shadow-[0_4px_24px_rgba(0,0,0,0.04)] rounded-3xl p-10 text-center space-y-6">
              <div className="w-16 h-16 bg-[#2563eb]/10 rounded-2xl flex items-center justify-center text-[#2563eb] mx-auto">
      ...
      <section className="py-20 md:py-32 text-center">
        <div className="container-custom">
          <div className="bg-white shadow-lg p-16 rounded-[3rem] border border-gray-100">
            <h2 className="text-4xl mb-8 text-gray-900">Not sure which system you need?</h2>
