  ...
  return (
    <div className="pt-32">
      ...
      <section className="container-custom mb-20 text-center">
        ...
        <h1 className="text-5xl md:text-8xl mb-8 text-gray-900 dark:text-white transition-colors duration-300">Engineering the Future of <br />Digital Nations.</h1>
      ...
      {/* Story */}
      <section className="py-20 md:py-32 bg-gray-50 dark:bg-[#111827] transition-colors duration-300">
        <div className="container-custom grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl text-gray-900 dark:text-white transition-colors duration-300">Our Vision</h2>
      ...
      <section className="py-20 md:py-32 container-custom">
        <h2 className="text-4xl text-center mb-20 text-gray-900 dark:text-white transition-colors duration-300">Why Choose WAOTN?</h2>
        <div className="grid md:grid-cols-3 gap-12">
          {[
            ...
            <div key={i} className="text-center space-y-6 bg-white dark:bg-slate-800 shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.4)] p-10 rounded-3xl transition-colors duration-300 border border-transparent dark:border-slate-700">
      ...
      {/* Team CTA */}
      <section className="py-20 md:py-32 container-custom text-center">
        <div className="max-w-3xl mx-auto space-y-10">
          <h2 className="text-4xl md:text-5xl text-gray-900 dark:text-white transition-colors duration-300">Join the Nation of Innovators.</h2>
          ...
          <div className="flex justify-center gap-6">
            <Link to="/contact" className="bg-[#2563eb] hover:bg-[#1d4ed8] text-white rounded-full font-semibold px-10 py-4 transition-colors duration-300 inline-flex items-center justify-center">Work With Us</Link>
            <Link to="/portfolio" className="border-2 border-[#2563eb] text-[#2563eb] hover:bg-[#2563eb] hover:text-white rounded-full font-semibold px-10 py-4 transition-colors duration-300 inline-flex items-center justify-center">See Our Legacy</Link>
          </div>
        </div>
      </section>
    </div>
