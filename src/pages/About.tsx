  ...
  return (
    <div className="pt-32">
      ...
      <section className="container-custom mb-20 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-blue-100 shadow-sm text-[#2563eb] text-sm font-semibold mb-6">
          <Globe size={14} /> <span>Global Full-Service Tech Partner</span>
        </div>
        <h1 className="text-5xl md:text-8xl mb-8">Engineering the Future of <br />Digital Nations.</h1>
      ...
      <section className="py-20 md:py-32 bg-gray-50">
        <div className="container-custom grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-6 rounded-2xl border border-blue-100 animate-float">
              <Sparkles className="text-[#2563eb] mb-2" size={32} />
              <div className="font-bold text-gray-900">Premium Quality</div>
              <div className="text-sm text-gray-500 font-medium">Guaranteed Excellence</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 container-custom">
        <h2 className="text-4xl text-center mb-20 text-gray-900">Why Choose WAOTN?</h2>
        <div className="grid md:grid-cols-3 gap-12">
          {[
            ...
            <div key={i} className="text-center space-y-6 bg-white shadow-[0_4px_24px_rgba(0,0,0,0.04)] p-10 rounded-3xl">
              <div className="w-20 h-20 bg-[#2563eb]/10 rounded-full flex items-center justify-center text-[#2563eb] mx-auto">
      ...
      <section className="py-20 md:py-32 container-custom text-center">
        <div className="max-w-3xl mx-auto space-y-10">
          <h2 className="text-4xl md:text-5xl text-gray-900">Join the Nation of Innovators.</h2>
