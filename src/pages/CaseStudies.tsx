      ...
      <div className="container-custom">
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl mb-8 text-gray-900">Engineering a $12M Intelligence Engine for Global Logistics</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-20">
            {/* Problem */}
            <section>
              <h2 className="text-3xl mb-6 flex items-center gap-3 text-gray-900">
            ...
            <section>
              ...
              <div className="bg-gray-100 text-gray-700 p-8 rounded-3xl border border-[#2563eb]/20 italic">
            ...
            <section>
              ...
              <div className="space-y-8">
                <div className="bg-white shadow-[0_4px_24px_rgba(0,0,0,0.04)] p-8 rounded-3xl border border-gray-100">
                  <h4 className="text-xl font-bold mb-2 text-gray-900">Phase 1: Data Normalization</h4>
                  <p className="text-gray-500">Cleaned and structured 10 years of historical logistics data to train the AI model.</p>
                </div>
                <div className="bg-white shadow-[0_4px_24px_rgba(0,0,0,0.04)] p-8 rounded-3xl border border-gray-100">
                  <h4 className="text-xl font-bold mb-2 text-gray-900">Phase 2: AI Engine Development</h4>
                  <p className="text-gray-500">Integrated OpenAI API with custom vector embeddings for company-specific logistics context.</p>
                </div>
                <div className="bg-white shadow-[0_4px_24px_rgba(0,0,0,0.04)] p-8 rounded-3xl border border-gray-100">
                  <h4 className="text-xl font-bold mb-2 text-gray-900">Phase 3: High-Performance UI</h4>
                  <p className="text-gray-500">Built a React-based real-time dashboard using WebSockets for live data streaming.</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <aside className="space-y-8">
            <div className="bg-white shadow-lg p-8 rounded-3xl border border-gray-100 sticky top-32">
              <h3 className="text-2xl mb-8 text-gray-900">At a Glance</h3>
              <div className="space-y-8">
                <div>
                  <div className="text-xs text-gray-400 uppercase tracking-widest font-bold mb-1">Timeline</div>
                  <div className="flex items-center gap-2 font-bold text-gray-900"><Clock size={16} className="text-[#2563eb]" /> 4 Months</div>
                </div>
                <div>
                  <div className="text-xs text-gray-400 uppercase tracking-widest font-bold mb-1">Industry</div>
                  <div className="flex items-center gap-2 font-bold text-gray-900"><Users size={16} className="text-[#2563eb]" /> Logistics / Tech</div>
                </div>
                <div>
